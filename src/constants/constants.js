export const projects = [
  {
    title: "Freelycomment",
    description:
      "Freelycomment is my main and most amibitious project. It's still in development and will be released to the public when finished as a full social network. Currently it's being refactored to use redux toolkit functionality to the fullest and to better normalize data. Excuse the lack of styling as I haven't yet started working on that area. It features real-time notifications with socket-io(only custom users for now, Google users coming soon). You can use any url to create a post and then comment and like other comments.",
